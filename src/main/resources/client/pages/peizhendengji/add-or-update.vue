	...
	<view :style='{"width":"100%","padding":"0 0 0 0","position":"relative","background":"#ff993310","height":"auto"}'>
		<form :style='{"width":"100%","padding":"24rpx 24rpx 24rpx 24rpx","background":"none","display":"block","height":"auto"}' class="app-update-pv">
			<view :style='{"padding":"4rpx 0 4rpx 0","margin":"0 0 24rpx 0","borderColor":"#eeeeee","alignItems":"center","borderWidth":"0px","background":"none","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="">
				<view :style='{"width":"160rpx","padding":"0 20rpx 0 0","lineHeight":"80rpx","fontSize":"28rpx","color":"#333333","textAlign":"right"}' class="title">陪诊等级</view>
				<input :style='{"border":"2rpx solid #eeeeee","padding":"0px 24rpx 0px 24rpx","margin":"0 0 0 0","color":"#666666","borderRadius":"0px","flex":"1","background":"#ffffff","fontSize":"28rpx","lineHeight":"64rpx","height":"64rpx"}' :disabled="ro.peizhendengji" v-model="ruleForm.peizhendengji" placeholder="陪诊等级"></input>
			</view>
			<view :style='{"padding":"4rpx 0 4rpx 0","margin":"0 0 24rpx 0","borderColor":"#eeeeee","alignItems":"center","borderWidth":"0px","background":"none","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="">
				<view :style='{"width":"160rpx","padding":"0 20rpx 0 0","lineHeight":"80rpx","fontSize":"28rpx","color":"#333333","textAlign":"right"}' class="title">陪诊费用</view>
				<input :style='{"border":"2rpx solid #eeeeee","padding":"0px 24rpx 0px 24rpx","margin":"0 0 0 0","color":"#666666","borderRadius":"0px","flex":"1","background":"#ffffff","fontSize":"28rpx","lineHeight":"64rpx","height":"64rpx"}' :disabled="ro.peizhenfeiyong" v-model="ruleForm.peizhenfeiyong" placeholder="陪诊费用"></input>
			</view>
	...
	export default {
		...
		async onLoad(options) {
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`peizhendengji`, this.ruleForm.id);
			...
			if(options.cross){
				...
				for (var o in obj){
					if(o=='peizhendengji'){
					this.ruleForm.peizhendengji = obj[o];
					this.ro.peizhendengji = true;
					continue;
					}
					if(o=='peizhenfeiyong'){
					this.ruleForm.peizhenfeiyong = obj[o];
					this.ro.peizhenfeiyong = true;
					continue;
					}
				}
			}
...
//跨表计算判断
				var obj;
				if((!this.ruleForm.peizhendengji)){
					this.$utils.msg(`陪诊等级不能为空`);
					return
				}
				if((!this.ruleForm.peizhenfeiyong)){
					this.$utils.msg(`陪诊费用不能为空`);
					return
				}
				if(this.ruleForm.peizhenfeiyong&&(!this.$validate.isNumber(this.ruleForm.peizhenfeiyong))){
					this.$utils.msg(`陪诊费用应输入数字`);
					return
				}
				//更新跨表属性
			       var crossuserid;
				...
				if(crossrefid && crossuserid) {
					...
					let res = await this.$api.list(`peizhendengji`, params);
                ...
                //跨表计算
						if(this.ruleForm.id){
							await this.$api.update(`peizhendengji`, this.ruleForm);
						}else{
							await this.$api.add(`peizhendengji`, this.ruleForm);
						}
