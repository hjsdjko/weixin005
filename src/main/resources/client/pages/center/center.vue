	...
	<view class="content">
		<view :style='{"width":"100%","padding":"0px 0 120rpx","position":"relative","background":"#ff993310","height":"auto"}'>
			<view v-if="user&&user.id" :style='{"border":"0px solid #3da742","padding":"48rpx 24rpx 24rpx 48rpx","margin":"0px 0px 20rpx 0px","borderRadius":"0px","background":"none","display":"flex","width":"calc(100% - 0px)","justifyContent":"space-between","height":"auto"}' class="header" v-bind:class="{'status':isH5Plus}" @tap="onPageTap2('../user-info/user-info',1)">
				...
				<view :style='{"padding":"60rpx 40rpx 60rpx 60rpx","alignItems":"center","flexWrap":"wrap","flexDirection":"column","background":"url(http://clfile.zggen.cn/20240116/7c3fa495ec18456db1985ed752f27670.png) no-repeat center top / 100% 100%","display":"flex","width":"calc(96% - 112rpx)","height":"100%"}' v-if="tableName=='huanzhe'" class="userinfo">
					...
					<view :style='{"margin":"20rpx 0 0 0","flex":"1","flexDirection":"column","display":"flex","width":"100%","justifyContent":"center","height":"100%"}' class="info">
						<view :style='{"width":"100%","lineHeight":"48rpx","fontSize":"28rpx","color":"#333","fontWeight":"600"}'>{{user.huanzhezhanghao}}<text v-if="user.vip&& user.vip=='是'">(VIP)</text></view>
					</view>
				</view>
				<view :style='{"padding":"60rpx 40rpx 60rpx 60rpx","alignItems":"center","flexWrap":"wrap","flexDirection":"column","background":"url(http://clfile.zggen.cn/20240116/7c3fa495ec18456db1985ed752f27670.png) no-repeat center top / 100% 100%","display":"flex","width":"calc(96% - 112rpx)","height":"100%"}' v-if="tableName=='peizhenyuan'" class="userinfo">
					<image :style='{"width":"108rpx","padding":"0 0 0 0","margin":"0 20rpx 0 0","borderRadius":"100%","float":"right","height":"108rpx"}' :src="user.zhaopian?baseUrl+user.zhaopian:'/static/gen/upload.png'"></image>
					<view :style='{"margin":"20rpx 0 0 0","flex":"1","flexDirection":"column","display":"flex","width":"100%","justifyContent":"center","height":"100%"}' class="info">
						<view :style='{"width":"100%","lineHeight":"48rpx","fontSize":"28rpx","color":"#333","fontWeight":"600"}'>{{user.peizhenyuanzhanghao}}<text v-if="user.vip&& user.vip=='是'">(VIP)</text></view>
					</view>
				</view>
		...
		methods: {
			...
			async updatePassword() {
				...
				if (this.tableName=='huanzhe') {
					password = this.user.huanzhemima;
				}
				...
				if (this.tableName=='huanzhe') {
					this.user.huanzhemima = this.passwordForm.newmima
				}
