...
public class YuyuexinxiController {
    ...
    public R page(@RequestParam Map<String, Object> params,YuyuexinxiEntity yuyuexinxi,
		...
		if(tableName.equals("peizhenyuan")) {
			yuyuexinxi.setPeizhenyuanzhanghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("huanzhe")) {
			yuyuexinxi.setHuanzhezhanghao((String)request.getSession().getAttribute("username"));
		}
